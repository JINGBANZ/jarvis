...
extension JarvisPrompts {
    public enum Coach {
        ...
        public static func system(
            ...
            explanationsEnabled: Bool = true, codeEnabled: Bool = false
        ) -> String {
            ...
            return (prepMaterial ? system + prepMaterialAddendum : system)
                + (explanationsEnabled ? explanationGuidance : "")
                + (codeEnabled ? codeGuidance : "") + language + formatAddendum
