...
private let detailGuidance = """
    ...
    hold: a code block or a diagram a loaded skill asked for, with any short contextual header that
    skill requires. Write explanation paragraphs there only when the
