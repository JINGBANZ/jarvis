...
These are prompt instructions, with no language-based rejection. One Start snapshots the provider,
OpenAI model/expected-language list, Gemini model/expected-language/vocabulary/mode, or Apple
