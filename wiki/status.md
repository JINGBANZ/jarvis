...
queues, including any cancelled turn, before enabling evaluation. CLI setup failures before inference
remain separate from provider-call totals, and malformed JSONL makes affected values explicitly
