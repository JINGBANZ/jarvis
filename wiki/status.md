...
- `Sources/JarvisOverlay/` — the capture-invisible `NSPanel` surfaces: `OverlayCaptionPanel` (transient), `OverlayBoxPanel` (persistent, with a fixed session-format header), `NSPanel+CaptureExclusion`.
