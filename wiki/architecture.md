...
shows the hint from its first character and follows each line as it is written. Measured on
Claude through the helper, the first character of a short hint reached the screen at about 1.1 s
