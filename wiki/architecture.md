...
closed, and the box shows the hint as soon as its first line closes and its detail as the model
writes it ([The detail box](#the-detail-box)). The first character of a
