...
- Jarvis does **not** auto-start: choose transcription and Primary brain providers in Settings, meet
  ...
  monochrome tile while stopped and a lit Listening Lens while a session exists: amber while starting
  or reconnecting, violet once ready, red when a requirement needs attention.
